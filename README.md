...
### Yêu cầu số 2: Tạo bảng copy dữ liệu hiện có
```sql
...
### Yêu cầu số 3: Copy toàn bộ dữ liệu từ file cũ sang file mới
```sql
INSERT INTO club_member_info_cleaned 
SELECT * FROM club_member_info ;
```
### Yêu cầu số 4: Clean dữ liệu
#### Yêu cầu số 4.1: Thống nhất cách viết hoa, viết thường và xóa khoảng trắng ở đầu và cuối tên ở cột full_name
```sql
UPDATE club_member_info_cleaned 
SET full_name = TRIM(LOWER(full_name));
```
#### Yêu cầu số 4.2: Đưa các tuổi năm ngoài độ tuổi thực tế thành độ tuổi trung vị của tập dữ liệu
```sql
UPDATE club_member_info_cleaned
SET age = 
(SELECT AVG(age) AS median_value
FROM (
    SELECT age 
    FROM club_member_info_cleaned 
    ORDER BY age 
    LIMIT 2 OFFSET (SELECT (COUNT(*) - 1) / 2 FROM club_member_info_cleaned)
) AS subquery)
WHERE age >100 OR age < 0 OR age = '';
```
++The result:++
...
|jori sanz|41|married|jsanz3i@google.cn|904-906-7537|99 West Crossing,Jacksonville,Florida|Professor|2/15/2012|
...
|carlye graeber|41|married|cgraeber6n@quantcast.com|214-345-1363|8 Dexter Junction,Dallas,Texas|Actuary|3/10/2021|
...
|shurwood strutley|41|married|sstrutley9w@craigslist.org|804-636-0234|7779 Main Road,Richmond,Virginia|Nuclear Power Engineer|6/30/2014|
...
|corbin hillan|41|single|chillandg@time.com|267-229-4017|78 La Follette Trail,Philadelphia,Pennsylvania|Account Representative II|7/7/2021|
...
|smitty bulmer|41|divorced|sbulmergm@addthis.com||23370 Forest Dale Street,Pittsburgh,Pennsylvania|VP Marketing|9/25/2017|
...
|leonore boothjarvis|41|married|lboothjarvisi2@bloglines.com|713-618-0516|33110 Luster Plaza,Houston,Texas|Sales Representative|6/13/2022|
...
|aundrea villar|41|married|avillarm8@privacy.gov.au|571-942-0462|58201 Utah Terrace,Arlington,Virginia|Senior Sales Associate|6/28/2012|
...
|chery batisse|41|divorced|cbatissen3@bandcamp.com|804-431-7226|604 Elgar Way,Richmond,Virginia|VP Product Management|7/30/2012|
...
|erina aubert|41|married|eaubertqp@cargocollective.com|615-711-2470|2597 Hallows Road,Nashville,Tennessee|Automation Specialist II|11/2/2012|
...
|baldwin rippen|41|single|brippen1z@nationalgeographic.com|912-469-5562|2 Esker Alley,Savannah,Georgia|Web Developer II|12/1/2015|
...
|cherise kristoffersson|41|divorced|ckristoffersson59@sun.com|806-779-9348|72793 Northridge Park,Lubbock,Texas|Director of Sales|8/2/2021|
...
|thorndike portingale|41|married|tportingale9n@nsw.gov.au|941-186-3805|9011 Huxley Plaza,Sarasota,Florida|Statistician II|2/16/2019|
...
|haskell braden|41|divorced|hbradenri@freewebs.com|510-963-9848|35005 Waubesa Crossing,Berkeley,California|Dental Hygienist|11/4/2015|
...
|montague latham|41|married|mlathame5@dailymotion.com|210-522-8041|0 Buhler Plaza,San Antonio,Texas|Administrative Officer|2/13/2021|
...
|virgina hubbock|41|single|vhubbockep@ed.gov|540-535-0069|7 Schmedeman Center,Roanoke,Virginia|Media Manager I|7/6/2021|
...
|denni stallard|41|single|dstallardl9@devhub.com|816-567-5883|73737 Kinsman Street,Saint Joseph,Missouri|Nuclear Power Engineer|7/3/2018|
...
|cathrine jonson|41|married|cjonsonol@aboutads.info|559-318-4841|4147 Swallow Hill,Fresno,California|Speech Pathologist|4/26/2022|
